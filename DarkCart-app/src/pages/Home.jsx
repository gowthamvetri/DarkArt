    ...
    <svg viewBox="0 0 1200 250" xmlns="http://www.w3.org/2000/svg">
      ...
      <g>
        ...
        <g transform="translate(1050, 125)">
          <rect x="-20" y="-20" width="40" height="40" fill="#ffffff" stroke="#333333" strokeWidth="2" />
          <line x1="-20" y1="-5" x2="20" y2="-5" stroke="#333333" strokeWidth="2" />
          <line x1="0" y1="-20" x2="0" y2="20" stroke="#333333" strokeWidth="2" />
        </g>
      </g>
      
      {/* Center white space for text */}
      <rect x="300" y="50" width="600" height="150" fill="#ffffff" rx="10" ry="10" />
      
      {/* Banner text */}
      <g>
        <text x="600" y="115" fontFamily="Arial, sans-serif" fontSize="60" fontWeight="bold" 
              fill="#333333" textAnchor="middle">DARK CART</text>
        <text x="600" y="160" fontFamily="Arial, sans-serif" fontSize="24" 
              fill="#3498db" textAnchor="middle">Shop Smarter, Not Harder</text>
      </g>
      ...
      <g>
        ...
        {/* Stars */}
        <path d="M350,80 l2,6 h6 l-5,4 l2,6 l-5,-3 l-5,3 l2,-6 l-5,-4 h6 Z" fill="#f39c12" />
        <path d="M850,80 l2,6 h6 l-5,4 l2,6 l-5,-3 l-5,3 l2,-6 l-5,-4 h6 Z" fill="#f39c12" />
        
        {/* Small device icons */}
        <g transform="translate(400, 200) scale(0.5)">
          <rect x="-15" y="-20" width="30" height="40" rx="3" ry="3" fill="#95a5a6" />
          <rect x="-10" y="-15" width="20" height="25" fill="#ecf0f1" />
          <circle cx="0" cy="15" r="3" fill="#ecf0f1" />
        </g>
        
        <g transform="translate(800, 200) scale(0.5)">
          <rect x="-20" y="-15" width="40" height="30" rx="3" ry="3" fill="#95a5a6" />
