    ...
    <section className='min-h-[75vh] max-h-[75vh] overflow-y-auto'>
        ...
        <div className='grid p-3'>
            <form className='grid gap-4' onSubmit={handleSubmit}>
                ...
                <div onClick={()=>setOpenAddField(true)} className=' hover:bg-yellow-400 bg-white py-1 px-3 w-32 text-center font-semibold border-2 border-yellow-200 hover:text-neutral-900 cursor-pointer rounded'>
                  Add Fields
                </div>

                <button
                  className='bg-yellow-300 hover:bg-yellow-400 py-2 rounded font-semibold'
                >
                  Submit
                </button>
            </form>
