...
const ConfirmBox = ({ cancel, confirm, close }) => {
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 bg-black/30 backdrop-blur-md flex items-center justify-center z-50'>
      <div className='bg-white w-full max-w-md p-4 rounded shadow-lg'>
        ...
        <p className='my-4'>Are you sure you want to permanently delete this item?</p>
