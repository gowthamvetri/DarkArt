      ...
      <div className="absolute inset-0 z-50 flex items-center justify-start">
        <div className="w-full max-w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
          <div className="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold text-white mb-2 sm:mb-3 md:mb-4 leading-tight drop-shadow-2xl">
              Fashion That 
              <span className="block text-gray-100">Defines You</span>
            </h1>
            <p className="text-gray-200 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mb-3 sm:mb-4 md:mb-6 leading-relaxed bg-black/30 backdrop-blur-lg border border-white/20 rounded-xl shadow-2xl p-3 sm:p-4 md:p-6">
              Explore our curated collection of premium clothing designed for the modern lifestyle.
            </p>
            <button className="bg-white text-black px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3 lg:px-8 lg:py-4 xl:px-10 xl:py-5 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold tracking-wide text-xs sm:text-sm md:text-base lg:text-lg transform hover:scale-105 shadow-2xl">
              Shop Collection
            </button>
          </div>
        </div>
